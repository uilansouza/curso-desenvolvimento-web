...
$('#btn_iniciar_jogo').click(function(){
	...
	$('.jogada').click(function(){
		...
		var id_campo_clicado = this.id // recupera o elemento
	...
	function jogada(id){
		...
		if((rodada %2)==1){
			var icone ='url("imagens/marcacao_1.png")';
			pontos = -1;
		}else{
			var icone ='url("imagens/marcacao_2.png")';
			pontos = 1;
		}
		...
		var linha_coluna = id.split('-')//trunca(separa) uma cadeia de string e coloca em um array
